export default class FormValidator {
  constructor(config, formIndividual) {
    ...
    this._inputList = Array.from(
      this._formIndividual.querySelectorAll(this._config.inputSelector)
    );
    this._buttonElement = this._formIndividual.querySelector(
  ...
  _displayInputError(inputElement, errorMessage) {
    const errorElement = this._formIndividual.querySelector(
